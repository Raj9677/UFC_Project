...
ui <- fluidPage(
  ...
  navbarPage(
    ...
    tabPanel("Home Page", 
             ...
             tags$br(),
             tags$br(),
             tags$b("Navigate through navigation bar at the top to discover different features and stats the app provides. "),
             tags$br(),
             tags$br(),
             tags$br(),
    ...
    tabPanel("Analysis",
             ...
             tags$br(),
             tags$br(),
             tags$b("The project started with us receiving kaggle dataset for UFC past matches for Red and Blue Fighters along with various characterstics of the fighters and the matches."),
             ...
             tags$b("Secodnly, the data provided had a lot of missing points and was not in the correct shape. As a result, we made sure that the columns having majority of data not available would not be a part of our analysis and prediction. "),
             tags$br(),
             tags$br(),
             tags$br(),
    ...
    tabPanel("Betting Optimizer",  
             ...
             tags$br(),
             tags$br(),
             tags$b("Although it would be impossible to make sure that you turn profit 100% times using betting as a tool in a probabilitic event, we could definitely use the principal of Expected value to have a stronger chance of making money over time. "),
             tags$b("The Expected Value principal basically mentions that higher the number of simulations for a event, closer the value would get to the Expected value. Therefore, overtime we would expect to make money over time."),
             tags$b("Here we combine the Odds presented to us and the probabilites of win for each fighter on a fight to see if we could get an Expected value above 0. Combining multiple expected value above 0 would eventually help us make money over time"),
             tags$br(),
             tags$br(),
             tags$b("Select Fields and Edit Columns as per your demands:"),
             tags$b("Select rows that you want to calculate betting on, make sure the values are present and valid. Character strings in Odds and probability will be coerced to NA."),
